...
<header class="navbar">
	...
	<div class="table">
	<div class="txt">
		<h1 class="features-t">Контакты наших филиалов</h1>
		...
		<table align="center" class="serv-tables" >
			...
			<?php $SERV = mysqli_query($dp, "SELECT * FROM адреса"); 
			while($outserv = mysqli_fetch_array($SERV))
			{
				echo '<tr>
				<td>'.$outserv[2].'</td><td>'.$outserv[3].'</td><td>'.$outserv[4].'</td><td><div class="navs-item notbtn"> <a href="#" class="txt-uppercase" onclick="openEmailForm(\''.$outserv[1].'\')">Написать на почту</a></div></td>
				</tr>';
			}
			echo "</table>"
			?>
    ...
    <div id="emailForm" style="display:none;">
        ...
        <form action="Home.php" method="post">
            <input type="email" name="recipient_email" id="recipient_email" placeholder="Почта автосалона" value="<?php echo $outserv[1]; ?>" readonly>
    ...
    function openEmailForm(email) {
        document.getElementById("recipient_email").value = email; // Заполнение поля адреса почты автосалона
